<template>
  <div>
    <h1>PSYKHE's Terms &amp; Conditions of Use</h1>
    ...
    <section>
      ...
      <p>
        <b
          ...
          <nuxt-link to="/">{{ currentHost }}</nuxt-link>
          (our site).</b
        >
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        Our site operated by Psykhe Ltd ("We"). We are a limited company, registered in England and Wales under company
        number 12140962 and have our registered office at 52 C/O Dragonfly, 52 High Street, Cottenham, Cambridgeshire,
        CB24 8SA. Our main trading address is 52 High Street, Cottenham, Cambridgeshire, CB24 8SA
      </p>
      <p>
        ...
        <a
          ...
          data-tld="com"
          @click="mailto('info', 'psykhefashion', 'com')"
        />
      </p>
    </section>
    ...
    <section>
      ...
      <ul>
        <li>
          <nuxt-link to="/privacy-policy">Our Privacy Policy</nuxt-link>
          . See further under
          <a href="#terms-and-conditions-personal-information">How we may use your personal information</a>
        </li>
        <li>, which sets out information about the cookies on our site.</li>
      </ul>
      <p>
        Any purchases you make via links that you click through our website are purchases made directly with those
        third-party sites. We are not a party to that transaction, and you should refer to their websites for their
    ...
    <section>
      ...
      <p>
        When you sign up for an account you provide us with your email address (which becomes your username) and a
        password. These are used as part of our security procedures, you must treat such information as confidential.
        You must not disclose it to any third party.
      </p>
      <p>
        We have the right to disable any username or password, whether chosen by you or allocated by us, at any time, if
        in our reasonable opinion you have failed to comply with any of the provisions of these terms of use.
      </p>
      <p>
        If you know or suspect that anyone other than you knows your user name or password, you must promptly notify us
        at
        <a
          class="obfuscated-email"
          data-addr="help"
    ...
    <section id="terms-and-conditions-how-you-may-use-material">
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            compensation. However, we will not be liable for damage that you could have avoided by following our advice
            to apply an update offered to you free of charge or for damage that was caused by you failing to correctly
    ...
    <section id="terms-and-conditions-personal-information">
    ...
    <section>
      ...
      <p>
        You may upload your photo to your profile page. You will not be able to upload any other material to our site.
      </p>
      <p>Any photo you upload to our site will be considered non-confidential and non-proprietary.</p>
    </section>
    ...
    <section>
      ...
      <p>
        "PSYKHE" and "The Psychology of Fashion" are UK-registered trademarks of Psykhe Ltd. You are not permitted to
        use them without our approval, unless they are part of material you are using as permitted under
        <a href="#terms-and-conditions-how-you-may-use-material">How you may use material on our site</a>
      </p>
    </section>
  </div>
</template>
...
@Component({ layout: 'unauthenticated' })
export default class TermsAndConditions extends Vue {
  get metaTitle() {
    return 'Terms of Use | PSYKHE';
  }

  get metaDescription() {
    return `Find all of the terms and conditions pertaining to using the PSYKHE's AI and psychology-powered shopping platform here. `;
  }
  ...
  head() {
    return {
      ...
      bodyAttrs: {
        class: 'page page-terms-and-conditions'
      },
      meta: [
